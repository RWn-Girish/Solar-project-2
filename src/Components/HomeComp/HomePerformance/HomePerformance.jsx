        ...
        <>
            <div className="home-performance">
                <div className="container">
                    <div className="home-performance__content  col-8">
                        ...
                        <div className="col-8">
                               <div className="rating=content">
                                   <p className="rating-desc">Solar Powering Your Sustainable Scene" is a vibrant and compelling phrase that conveys the idea of integrating solar energy into</p>
                    ...
                    <div className="home-performance_image col-4"></div>
                </div>
            </div>
        </>
    )
